...
>
  <div
    className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center max-w-7xl w-full"
    data-aos="fade-up"
  >
    {/* Left: Text Content */}
    <div className="space-y-4 sm:space-y-6 text-center md:text-left">
      <h1 className="text-3xl sm:text-4xl md:text-6xl lg:text-7xl font-extrabold font-serif leading-tight dark:text-white">
        I{" "}
        <span
      ...
      <p className="text-gray-700 dark:text-gray-300 text-base sm:text-lg md:text-xl font-mono max-w-lg mx-auto md:mx-0">
        Building{" "}
      ...
      <div className="flex flex-wrap gap-3 sm:gap-4 justify-center md:justify-start">
        <a
          href="/contact"
          className="px-5 sm:px-7 py-2 sm:py-3 rounded-full bg-blue-600 text-white font-semibold 
        ...
        <a
          href="/services"
          className="px-5 sm:px-7 py-2 sm:py-3 rounded-full border-2 border-blue-600 
    ...
    <div className="flex justify-center" data-aos="zoom-in">
      <div className="rounded-2xl w-full max-w-[250px] sm:max-w-xs md:max-w-md lg:max-w-lg">
        <Player
          autoplay
          loop
  ...
  {/* Scroll Indicator */}
  <div className="lg:absolute hidden lg:flex bottom-6 left-1/2 -translate-x-1/2">
